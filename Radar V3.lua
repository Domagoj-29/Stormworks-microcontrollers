...
function onTick()
	...
	local directionalSpeed=input.getNumber(7)

	local inputX=input.getNumber(8)
	local inputY=input.getNumber(9)
	WaypointX=input.getNumber(10)
	WaypointY=input.getNumber(11)

	RadarRange=input.getNumber(12)
	local radarElevation=input.getNumber(13)
	local radarYaw=input.getNumber(14)
